...
class Data:
    ...
    MEETING_TIMES = [["LEC1", "From 9:00 AM  to   11:00 AM"], ["LEC2", "From 11:00 AM  to  1:30 PM"], ["LEC3", "From 2:00 PM  to  4:00 PM"], ["LEC4", "From 4:00 PM  to  6:00 PM"]]
    INSTRUCTORS = [["I1", "DR/ AMR S. GHONIEM"], ["I2", "DR/ Mohamed Elsaid"],["I3", "DR/ Salwa moustafa"], ["I4", "DR/ MANAL ABD EL KADER"]]
    ...
    def __init__(self):
        ...
        dept1 = Department("MI", [course1, course3])
        dept2 = Department("CS", [course2, course4, course5])
        dept3 = Department("IS", [course6, course7])
...
DisplayData.print_available_data()
generationNumber = 1
...
DisplayData.print_generation(population)
DisplayData.print_schedule_as_table(population.get_schedules()[0])
